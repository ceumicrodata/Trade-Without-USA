module ImpvolOutput
	...
	function write_results(parameters, rootpath = "experiments/baseline/", key = :real_GDP, bool_detrend = true, dirsdown = 1, pattern = r"jld2$")
		...
		stats = DataFrame([String, Float64, Float64, Float64, Float64, Float64, Float64, Float64, Float64, Float64], [:country_names, :actual, :kappa1972, :nosectoral, :nosectoral_kappa1972, :onlyglobal, :onlyglobal_kappa1972, :trade_barriers, :diversification, :specialization], 25)
